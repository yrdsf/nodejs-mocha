            ...
            stage('Sonar Net') {
                ...
                withSonarQubeEnv('Sonar Qube Server') {
                    dir('./net/net-nunit') {
                        ...
                        bat "${sqScannerMsBuildHome}\\SonarQube.Scanner.MSBuild.exe begin /k:ws.aqt /n:\"AQT - WS - \" /d:sonar.host.url=%SONAR_HOST_URL% /d:sonar.login=%SONAR_AUTH_TOKEN% /d:sonar.branch=${branchName} /d:sonar.inclusions=**/*.cs /d:sonar.cs.nunit.reportsPaths=\"%CD%\\opencover.xml\""
